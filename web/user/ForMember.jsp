                                ...
                                <center>
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="c" items="${clubMember}" begin="${startIndex}" end="${endIndex}" varStatus="loop">
                                                <tr>
                                                    <td>${loop.index + 1}</td>
                                                    <td>${c.code}</td>
                                                    <td>${c.name}</td>
                                                    <td>${c.dateCreated}</td>
                                                    <td>
                                                        <a href="<%=request.getContextPath()%>/user?command=IsMember&cID=${c.ID}&cCID=${c.creatorID}">View</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
