...
VALUES ('DEV','Dever', N'Dever là một câu lạc bộ học thuật, theo xu hướng nghiên cứu và phát triển sản phẩm', 1, '2017-11-15', 1, 1);

INSERT INTO Clubs (ClubCode, ClubName, ClubDescription, ClubCreatorID, DateCreated, ClubStatus, JoinRequest)
VALUES ('NYS','NYS Club', N'Name Your Soul CLB Nghệ Thuật FUDN', 2, '2019-10-12', 1, 1);

INSERT INTO Clubs (ClubCode, ClubName, ClubDescription, ClubCreatorID, DateCreated, ClubStatus, JoinRequest)
VALUES ('MJC','Mirai JC', N'FUDA Japanese Club Chúng mình là câu lạc bộ về văn hóa và học thuật của Nhật Bản trực thuộc', 3, '2021-07-15', 1, 1);
...
INSERT INTO Clubs (ClubCode, ClubName, ClubDescription, ClubCreatorID, DateCreated, ClubStatus, JoinRequest)
VALUES ('EVO','EVo - FUDA Event Club', N'CLB sự kiện trực thuộc FPT University Đà Nẵng, CLB báo nhất trường!', 5, '2018-07-23', 1, 1);
...
INSERT INTO Clubs (ClubCode, ClubName, ClubDescription, ClubCreatorID, DateCreated, ClubStatus, JoinRequest)
VALUES ('EFL','EFlame', 'English Club FPTU Danang. Leave A Memorable Experience!', 7, '2018-07-18', 1, 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
...
INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (1, 8, 0, '2021-08-08', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (2, 9, 0, '2021-09-09', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (3, 10, 0, '2021-10-10', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (4, 11, 0, '2021-11-11', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (5, 12, 0, '2021-12-12', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (6, 13, 0, '2022-01-01', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (7, 14, 0, '2022-02-02', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (1, 16, 0, '2022-03-03', 1);

INSERT INTO Member (ClubID, UserID, IsClubManager, JoinDate, MemberStatus)
VALUES (2, 17, 0, '2022-04-04', 1);


-- Adding records to the "Rating" table
INSERT INTO Rating (Vote, Note, MemberID)
VALUES (5, 'Great club!', 1);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (4, 'Good club!', 2);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (3, 'Average club.', 3);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (5, 'Amazing experience!', 4);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (2, 'Not satisfied.', 5);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (4, 'Fun activities!', 6);

INSERT INTO Rating (Vote, Note, MemberID)
VALUES (5, 'Highly recommended!', 7);

-- Adding records to the "Post" table
INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('My experience at Club XYZ', 'I had a great time at Club XYZ. Highly recommended!', '2022-01-01', 1, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('Club ABC event announcement', 'Join us for an exciting event at Club ABC!', '2022-02-02', 2, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('Looking for new members', 'Our club is looking for enthusiastic individuals to join us!', '2022-03-03', 3, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('Club XYZ updates', 'Stay tuned for the latest updates from Club XYZ.', '2022-04-04', 4, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('My favorite club activities', 'Here are some of my favorite activities at Club ABC.', '2022-05-05', 5, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('Upcoming event at Club XYZ', 'Save the date for our upcoming event at Club XYZ!', '2022-06-06', 6, 1);

INSERT INTO Post (PostTitle, PostDescription, PostDate, MemberID, PostStatus)
VALUES ('Join us for a workshop', 'Don not miss our workshop on topic X. Register now!', '2022-07-07', 7, 1);
...
INSERT INTO [Event] (EventName, EventDesription, EventDate, MemberID, EventStatus)
