...
<section id="detail">
    ...
    <Table>
        <tbody>
            ...
            <tr>
                <TH>User Password</TH><TD>${The_User.userPass}</TD><TD> <input type="text" name="userPass" value="${The_User.userPass}"></TD>
            <tr>
                <TH>User Phone</TH><TD>${The_User.userPhone}</TD><TD> <input type="text" name="userPhone" value="${The_User.userPhone}"></TD>
            <tr>
                <TH>User DOB</TH><TD>${The_User.DOB}</TD><TD> <input type="text" name="DOB" value="${The_User.DOB}"></TD>
            <tr>
